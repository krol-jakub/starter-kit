...
insert into book (id, title) values (42, 'Autostopem przez Galaktyke')
...
insert into author (id, first_name, last_name) values (10, 'Douglas', 'Adams');
...
insert into book_author(book_id, author_id) values (42, 10);

insert into library(id, name) values (1, 'Biblioteka Uniwersytecka')
insert into library(id, name) values (2, 'Biblioteka Aleksandryjska')
insert into library(id, name) values (2, 'Biblioteka Uniwerytetu Sankore')